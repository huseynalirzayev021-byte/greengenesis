    ...
    <footer className="bg-card border-t">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-base">{t("greenRewards.partnerVendors")}</h3>
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-base">{t("footer.contact")}</h3>
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <MapPin className="h-4 w-4 flex-shrink-0" />
                <span>{t("aboutUs.addressValue")}</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <div className="mt-12 pt-8 border-t">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">
              2024 GreenGenesis. {t("footer.allRightsReserved")}
            </p>
            <p className="text-sm text-muted-foreground">
